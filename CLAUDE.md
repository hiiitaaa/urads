...
セルフホストユーザーがAIにセットアップを案内してもらえるよう、以下を徹底する:

- `docs/threads_api_setup.md` と `docs/cloudflare_setup.md` は**実際の画面と一致する手順**を記載する
- Worker側のコード変更を含むアップデート時は、再デプロイ手順を含む **AI向けセットアップガイド** をリリースノートまたはドキュメントに含める
- 画面変更があった場合はドキュメントを即座に更新する
